    ...
    <div className='w-[60%] mt-10 mx-auto max-sm:w-[90%] max-sm:h-[100vh]'>
      ...
      </div>
      {
        pastes.length > 0 ?
          ...
          </div> : <div className='w-[60%] mt-10 mx-auto max-sm:w-[90%] max-sm:h-[100vh]'>
            <div className='rounded-sm w-100% bg-white flex justify-center items-center'>
              <h1 className='text-xl font-black'>No Pastes Found</h1>
            </div>
          </div>
      }
    </div>
